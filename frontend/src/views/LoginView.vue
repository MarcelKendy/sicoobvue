...
<script>
  ...
  export default {
    ...
    components: {
      LoginComponent, CardWelcomeComponent
    },
    mounted: function () {
      window.setInterval(() => {
...
.bg {
   ...
   position: relative;
    ...
    background: url( 'https://random.imagecdn.app/1920/1080') no-repeat center center;
...
.date-time-div {
  position: absolute; bottom: 20px; right: 25px;font-family: 'Quicksand', sans-serif; color: white
}
.date-time {
  font-weight: bolder;
  font-size: 12px;
