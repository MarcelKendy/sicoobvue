    ...
    >
      ...
      <v-card-title class="info-cards-text">
        <v-row class="align-center">
          <v-col cols="12" :md="total.length > 9 ? '6' : '7'">
            <span>Comissionamento R$</span>
          </v-col>
          <v-col cols="12" :md="total.length > 9 ? '6' : '5'">
            <div
              class="chip gradient-white-blue"
